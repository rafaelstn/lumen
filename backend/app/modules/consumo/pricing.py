...
- O preço por crédito de referência é mantido em Decimal só para cálculo (nunca float,
  nunca arredondado para inteiro antes de multiplicar).
...
# Preço de referência por crédito, em CENTAVOS (Decimal). Fonte do custo gravado no
# ConsultaLog. Preserva a fração de centavo do pacote CNPJá.
