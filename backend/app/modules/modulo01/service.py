...
def _result(row: pd.Series) -> dict:
    return {
        ...
        "status_cnd": row.get("status_cnd"),
        "cnd_descricao": row.get("cnd_descricao"),
        "risco_2027": row.get("risco_2027"),
        "motivo_risco": row.get("motivo_risco"),
        "impacto_financeiro_anual": row.get("impacto_financeiro_anual"),
