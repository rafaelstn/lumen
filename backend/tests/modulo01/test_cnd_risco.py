...
def test_risco_grupo_a_com_debito_e_alto():
    # Impacto = ICMS real aproveitado (total_valor_icms), não compras x alíquota.
    fornecedores = [
        {"grupo": "A", "status_cnd": cnd.POSITIVA, "total_compras": 100000.0, "aliquota_max": 18.0, "total_valor_icms": 17000.0},
        {"grupo": "A", "status_cnd": cnd.NEGATIVA, "total_compras": 50000.0, "aliquota_max": 12.0, "total_valor_icms": 6000.0},
        {"grupo": "A", "status_cnd": cnd.FALHA, "total_compras": 10000.0, "aliquota_max": 18.0, "total_valor_icms": 1800.0},
        {"grupo": "C", "status_cnd": cnd.POSITIVA, "total_compras": 30000.0, "aliquota_max": 0.0, "total_valor_icms": 0.0},
    ]
    risk.aplicar_risco(fornecedores)
    assert fornecedores[0]["risco_2027"] == risk.ALTO
    assert fornecedores[0]["impacto_financeiro_anual"] == 17000.00
...
def test_alertas_ordenados_por_impacto():
    fornecedores = [
        {"grupo": "A", "status_cnd": cnd.POSITIVA, "total_compras": 10000.0, "aliquota_max": 18.0, "total_valor_icms": 1500.0},
        {"grupo": "A", "status_cnd": cnd.POSITIVA, "total_compras": 100000.0, "aliquota_max": 18.0, "total_valor_icms": 16000.0},
    ]
    risk.aplicar_risco(fornecedores)
